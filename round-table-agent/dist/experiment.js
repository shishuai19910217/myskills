...
async function singleModelBaseline(topic, providerId) {
    const raw = await chat(providerId, [
        {
            role: "system",
...
async function roundTable(topic, seats, maxRounds) {
    const input = { id: `exp-${Date.now()}`, source: "text", content: topic };
