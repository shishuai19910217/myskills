...
export function enabledProviders(cfg: AppConfig): ProviderConfig[] {
...
export function loadSeats(overrides?: SeatConfig[]): SeatConfig[] {
...
export function getAuthKey(keyName: string): string {
